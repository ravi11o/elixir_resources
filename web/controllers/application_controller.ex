defmodule ElixirResources.ApplicationController do
  ...
  def create(conn, %{"application" => application_params}) do
    ...
    application_params = 
      if Query.check_slug(Application, slug) do
        Map.put_new(application_params, "slug", slug <> "-" <> UUID.uuid1())
      else
        Map.put_new(application_params, "slug", slug)
      end
